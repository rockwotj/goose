...
function extensionToMCPServer(extension: Extension): MCPServer {
  return {
    ...
    link: extension.link || '',
    installation_notes: '',  // Added this field
    endorsed: false,        // Added this field
        ...
        <div className="card">
          <div className="card-header">
            <div className="card-header-content">
              ...
              <Link to={`/prompt-library/detail?id=${prompt.id}`} className="home-page-server-name">
                {prompt.title}
              </Link>
            </div>
          </div>
          <div className="card-content">
            ...
            <div className="card-footer">
              <Link
                ...
                className="view-details-link text-sm text-textProminent hover:text-textProminent/80"
              >
                View Details
